...
import com.inforcap.PruebaFinalAppAndroid.viewmodel.MovieViewModel
...
//    }
    ...
    private fun initRecyclerView() {
        ...
        layoutManager.also { binding.rvMovies.layoutManager = it }
        ...
        adapterMovie.also { binding.rvMovies.adapter = it }
       // onItemSelected()
